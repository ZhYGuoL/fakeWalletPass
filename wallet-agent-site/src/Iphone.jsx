/**
 * iPhone 15 Pro frame - SVG vector adapted from MagicUI
 * (https://magicui.design/docs/components/iphone), MIT-licensed.
 * Ported to plain JSX/CSS and extended to render arbitrary `children`
 * behind the masked screen cutout.
 */
...
export function Iphone({ className = "", children, style, ...props }) {
  return (
    <div
      className={`device ${className}`.trim()}
    ...
    >
      ...
      >
        ...
        <path
          ...
          className="dv-frame dv-frame--edge"
        ...
        <defs>
          <linearGradient id="ipTitanium" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" className="ti-a" />
            <stop offset="0.5" className="ti-b" />
            <stop offset="1" className="ti-a" />
          </linearGradient>
